...
public class GalinhaController {
  ...
  @PostMapping
  public ResponseEntity<GalinhaResponseDTO> cadastrar(
      @Valid @RequestBody GalinhaRequestDTO galinhaRequestDTO) {
  ...
  @PutMapping("/{uuid}")
  public ResponseEntity<GalinhaResponseDTO> alterar(@PathVariable UUID uuid,
      @RequestBody GalinhaRequestDTO galinhaRequestDTO) {
